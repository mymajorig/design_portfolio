...
export const PROJECTS = [
  ...
  },
  {
    ...
    goals:
      "As a CS major with a newfound passion for design at a university where the two fields of study are kept very separate, I wanted a project that would let me bridge them. I originally planned to build an informational, interactive website guiding people to the right skincare and haircare routine. <br> But partway through, I realized there was a bigger gap to close first: before making any more designs, I needed to fully establish myself as a designer. So I shifted directions and decided to dedicate the summer to building my own personal portfolio instead, treating it as a way to learn the actual mechanics of design, not just apply them.",
    impact:
      "This project taught me that learning design is just as involved as learning to code, and just as prevalent to my growth. Working with mentors at LACRM to choose my tools and scope the project gave me a real sense of what an intentional design process looks like, from research and inspiration-gathering to critique and iteration. <br> It also pushed me to be honest with myself when something wasn't working. Even after I fixed alignment and structural issues, the site still didn't feel like me, so I went back to gathering inspiration rather than settling. That habit of iterating past 'functional' toward 'authentic' is something I now carry into every project.",
    process:
      "I started by evaluating my toolkit: HTML and CSS were familiar, Figma was somewhat familiar, and Three.js and PHP were completely new. Over several weeks, I met with LACRM employees to find the mentor who'd be the best fit for the project, then used our paired programming sessions to draft timelines and identify the resources I'd need. <br> Early versions focused on getting layout and structure right, but once that was solved, something still felt off, many of the design choices didn't feel like mine. That sent me back into research and inspiration-gathering, which I learned is just as core to the design process as building. I decided I still wanted 3D to play a role, but in a more minimalistic way. Since this is my personal portfolio, I wanted the main content, my projects and the text, to stay front and center, with the 3D elements working in support rather than competing for attention.",
    final_design:
      "The final site uses Three.js sparingly and deliberately: minimalist 3D elements that help the portfolio stand out and get noticed, while the projects and informational text remain the primary content. Rather than treating 3D as decoration, I used it as a tool to enhance discoverability and first impressions, letting the substance of the work speak for itself once someone's attention is caught.",
    final_design_images: ["images/blue-book.png", "images/cake.png"],
    keyLearnings: [
      "<b>Design is a skill you build, not a switch you flip.</b> <br> Coming from a CS background, I assumed good design was mostly instinct. This project showed me it's a learnable discipline with its own process, research, critique, iteration, just like engineering.",
      "<b>Don't settle just because something 'works.'</b> <br> Fixing alignment and structure wasn't enough if the result didn't feel authentically mine. Recognizing that gap and going back to inspiration instead of shipping something merely functional was one of the most valuable design lessons I took away.",
      "<b>Restraint is a design choice.</b> <br> I originally wanted 3D to be a centerpiece, but scaling it back to a minimalistic, supporting role made the site stronger. Letting my projects and writing stay the main content, with 3D as an accent for standout appeal, taught me that less deliberate use can have more impact."
    ],
    sortOrder: 0,
    themeColor: "#7b42ff"
  },
